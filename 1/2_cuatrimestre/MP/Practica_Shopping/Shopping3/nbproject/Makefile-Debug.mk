...
LDLIBSOPTIONS=-L../AnsiTerminal -L../DataTable ../AnsiTerminal/dist/Debug/GNU-Linux/libansiterminal.a ../DataTable/dist/Debug/GNU-Linux/libdatatable.a

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping3

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping3: ../AnsiTerminal/dist/Debug/GNU-Linux/libansiterminal.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping3: ../DataTable/dist/Debug/GNU-Linux/libdatatable.a

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping3: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/shopping3 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${TESTDIR}/tests/10.Integration_WEEK_2.o: tests/10.Integration_WEEK_2.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -I../DataTable/include -I../AnsiTerminal/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_2.o tests/10.Integration_WEEK_2.cpp


${TESTDIR}/tests/10.Integration_WEEK_3.o: tests/10.Integration_WEEK_3.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -D__INTEGRATION__ -I../MPTest/include -I../googletest-master/googletest/include -Iinclude -I../DataTable/include -I../AnsiTerminal/include -I. -std=c++14 -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/10.Integration_WEEK_3.o tests/10.Integration_WEEK_3.cpp
