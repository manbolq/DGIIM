...
public class SpaceStationToUI {
    ...
    public String toString(){
        String out = "Space Station - Name: " + name + "\n" +
                     "\tnMedals: " + nMedals + ", Fuel units: " + fuelUnits + ", Power: " + ammoPower + ", Shields: " + shieldPower + "\n" +
                     "\tWeapons: " + weapons.toString() + "\n" +
                     "\tShieldBooster: " + shieldBoosters.toString() + "\n" +
                     "\tHangars: " + hangar.toString() + "\n" +
                     "\tPedingDamage: " + pendingDamage.toString() + "\n" +
