...
public :
    ...
    /**
      * @brief Calcula la media de los pixeles de una imagen entera o de un fragmento de esta
      * @param i Fila de la imagen en la que se encuentra la esquina superior izquierda del fragmento
      * al que se le va a calcular la media.
      * @param j Columna de la imagen en la que se encuentra la esquina superior izquierda del fragmento
      * al que se le va a calcular la media.
      * @param height Numero de filas que tiene el fragmento al que se le va a calcular la media.
      * @param width Numero de columnas que tiene el fragmento al que se le va a calcular la media.
      * @pre 0 <= @p i < rows
      * @pre 0 <= @p j < cols
      * @pre 1 <= @p heigh < rows - @p i + 1
      * @pre 1 <= @p width < cols - @p j + 1
      * @return La media aritmetica de los pixeles
    ...
    /**
      ...
      * @pre @p factor > 0
      * @returfgn La imagen iconizada
      * @post Lgt4a imagen original no se modifica
      * @post La imagen resultante tendrá tamaño int(rows/@p factor) x int(cols/@p factor). Descartando los
      * decimales de la division.
      */
